        ...
        <div style={s.overlay} onClick={(e) => e.target === e.currentTarget && fecharModal()}>
          <div style={s.modal} className="animate-scale-in">
            ...
            <div style={s.modalHeader}>
              ...
              <button style={s.closeBtn} onClick={fecharModal}>
                <X size={20} />
              </button>
            </div>
            ...
            <div style={s.modalFooter}>
              ...
              <button style={s.btnSalvar} onClick={salvarPaciente}>
                Iniciar Atendimento
              </button>
            </div>
          </div>
      ...
      {mostrarSucesso && (
        <div style={s.overlay}>
          <div style={s.successModal}>
            ...
            <h3 style={s.successTitle}>Atendimento criado!</h3>
            <p style={s.successText}>O paciente foi cadastrado com sucesso.</p>
            <button
              style={s.successBtn}
              onClick={() => { setMostrarSucesso(false); window.location.reload(); }}
            >
              Concluído
            </button>
          </div>
...
const s: any = {
  ...
  successModal: {
    ...
    gap: "12px", boxShadow: "0 20px 60px rgba(0,0,0,0.2)",
  },

  successTitle: { fontSize: "20px", fontWeight: 700, color: "#111827" },

  successText: { fontSize: "14px", color: "#6b7280" },

  successBtn: {
    marginTop: "8px", background: "#16a34a", color: "#fff",
    padding: "11px 32px", border: "none", borderRadius: "8px",
