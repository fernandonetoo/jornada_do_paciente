...
export default function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/alterarsenha" element={
        <ProtectedRoute permitido={["paciente", "medico_ubs", "medico_oncologista", "admin"]}>
          <AlterarSenha />
        </ProtectedRoute>
      } />
      ...
      <Route path="/perfil1" element={
        <ProtectedRoute permitido={["medico_ubs", "medico_oncologista", "admin"]}>
          <Perfil1 />
        </ProtectedRoute>
      } />
